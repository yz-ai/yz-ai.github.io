...
![Şekil 5.1: Approximate state-value functions for the blackjack policy that sticks only on 20 or 21, computed by Monte Carlo policy evaluation.]({{ site.url }}/assets/images/RL-sutton-ozet/sekil-50.png)
