...
__*Şekil 8.2 :*__ *Basit labirent (üst metin) ve gerçek adım başına planlama adımı (n) sayılarında değişen Dyna-$$Q$$ aracıları için ortalama öğrenme eğrileri. Amaç (S)'den (G)'ye en kısa yoldan ulaşmaktır.*
...
__*Şekil 8.3 :*__ *İkinci bölümün yarısında Dyna-$$Q$$ ajanlarının planlanması ve planlamaması ile bulunan politikalar. Siyah kare ajanın yerini gösterir.*
...
$$Q(s,a) \gets \sum\limits_{s',r}\big[r + \gamma \max\limits_{a'} Q(s',a') \big] \qquad (8.1)$$

Bir sonraki durum ve ödül, $$S^{'}$$ ve $$R$$ modelinden örnek verirsek $$s, a $$ için örnek güncellemesi,

$$Q(s,a) \gets Q(s,a) + \alpha \bigg[R + \gamma Q(S', a') - Q(s,a)\bigg] \qquad (8.2)$$
...
![SEKİL-8.7]({{ site.url }}/assets/images/RL-sutton-ozet/sekil-87.png)

__*Şekil 8.7 :*__ *Beklenen ve örnek güncellemelerin verimliliğinin karşılaştırılması.*
